...
def process_email(email_contents: str) -> List[int]:
    ...
    email_contents = re.sub(r'\b[\w\.-]+@[\w\.-]+\b', 'emailaddr', email_contents)
    ...
    return word_indices
#print(process_email("anyon know how much it cost to host a web portal well it depend on how mani visitor your expect thi can be anywher from less than number buck a month to a coupl of dollarnumb you should checkout httpaddr or perhap"))